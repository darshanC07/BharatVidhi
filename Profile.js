            ...
            <ScrollView >
                ...
                <Image source={require('./assets/Profile_page.png')} style={styles.pfp}></Image>
                        <View style={styles.data}> 
                            <Details name={"Darshan"} age={'17'} email={'d..@gmail.com'}/>
                            ...
                            <View style={styles.score}>
                                <Text style={{fontSize:24,left:20,fontFamily:'Iceland_400Regular'}}>Statistics</Text>
                                
                                <View style={{flexDirection:'row',gap:20,paddingLeft:30}} > 
                                    <Image source={require('./assets/Pie chart.png')} style={{height:120,width:120}}/>
                                   <Text style={{fontFamily:'Iceland_400Regular',alignSelf:'center'}}>User stats</Text> 
                                </View>
                                <View style={{flexDirection:'column',gap:10}}>
                                <Text style={{fontFamily:'Iceland_400Regular',alignSelf:'center'}}>Leader board stats</Text>
                                ...
                                <View style={{flexDirection:'row',gap:20,paddingLeft:30}}>
                                <Text style={{fontFamily:'Iceland_400Regular',alignSelf:'center'}}>Civic mastery stats</Text> 
                                <Image source={require('./assets/Analysis.png')} style={{height:130,width:130}}/>
                                </View>
                            </View>
                            <View style={styles.set1}>
                               ...
                               <TouchableOpacity>
                               <View style={{flexDirection:'row',gap:20,paddingLeft:20}} onPress={() => navigation.navigate('Learning')}>
                                    <Image source={require('./assets/Stamp.png')} style={{height:30,width:30}} />
                        ...
                        <Text style={{fontSize:18,alignSelf:'center',top:10,fontFamily : 'Itim_400Regular'}}>Log out</Text>
                       </View>
                        </TouchableOpacity>
