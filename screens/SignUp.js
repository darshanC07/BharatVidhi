...
import { StyleSheet, Text, View, Image, TextInput, KeyboardAvoidingView, ScrollView, TouchableWithoutFeedback ,Platform} from 'react-native';
      ...
      <View style={styles.container}>
        ...
        <View style={styles.borderContainer}>
          ...
          <View style={{
            ...
            <Text style={styles.toLogin}>Already have a account?</Text>
